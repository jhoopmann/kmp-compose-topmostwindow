                        ...
                        fun update() {
                            ComposeWindowHelper.getUpdateScopeSetMethod().apply {
                                ...
                                if (platform == Platform.Mac) {
                                    /* We have to create NSWindow with given flags bevor calling setResizable,
                                       otherwise setWindowCollectionBehavior won't get applied later on in TopMost.kt.
                                       Do not ask me why, I haven't figured out which styleBits are responsible yet,
                                       but it works. However, it would be created by setSizeSafely directly after
                                       invocation of UpdateScope.update anyway and resizing still works this way */
                                    window.addNotify()
                                }
